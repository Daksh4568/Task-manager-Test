...
const connectionURL = 'mongodb+srv://raam1krishna123:ddfbci8SvvYdTjUp@taskmanagercluster1.gdf4i.mongodb.net/?retryWrites=true&w=majority&appName=TaskManagerCluster1'; // Use '127.0.0.1' (localhost) and port 27017 (default MongoDB port)
...
async function connectToDatabase() {
  try {
    ...
    await client.close(); // Close the MongoDB connection to free up resources
  } catch (error) {
